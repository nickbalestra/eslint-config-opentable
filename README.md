# eslint-config-opentable [![Build Status](https://travis-ci.org/opentable/eslint-config-opentable.svg?branch=legacy)](https://travis-ci.org/opentable/eslint-config-opentable)
